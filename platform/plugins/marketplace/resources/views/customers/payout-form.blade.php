        ...
        <div class="ps-form__content">
            <div class="form-group">
                ...
                {!! Form::customSelect(
                    ...
                    Arr::pluck($payoutMethodsEnabled, 'label', 'key'),
                    $model->vendorInfo->payout_payment_method,
                ) !!}
                    ...
                    @class([
                        ...
                        'd-none' =>
                            old(
                                'payout_payment_method',
                                $model->vendorInfo->payout_payment_method ?:
                                \Botble\Marketplace\Enums\PayoutPaymentMethodsEnum::BANK_TRANSFER) != $method['key'],
                    ])
                >
