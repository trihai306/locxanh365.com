    ...
    <tbody>
        <tr class="border-pay-row">
            ...
            <td style="width: 20%;">
                <img
                    class="filter-black"
                    src="{{ url('vendor/core/plugins/stripe/images/stripe.svg') }}"
                    alt="stripe"
                >
            </td>
            ...
            <td colspan="3">
                ...
                >
                    <div class="payment-name-label-group @if ($stripeStatus == 0) hidden @endif">
                        ...
                        <label
                            class="ws-nm inline-display method-name-label">{{ setting('payment_stripe_name') }}</label>
                    </div>
                </div>
                <div class="float-end">
                    <a
                        class="btn btn-secondary toggle-payment-item edit-payment-item-btn-trigger @if ($stripeStatus == 0) hidden @endif">{{ trans('plugins/payment::payment.edit') }}</a>
                    <a
                        class="btn btn-secondary toggle-payment-item save-payment-item-btn-trigger @if ($stripeStatus == 1) hidden @endif">{{ trans('plugins/payment::payment.settings') }}</a>
                </div>
            </td>
        </tr>
                    ...
                    <div class="col-sm-6">
                        <ul>
                            ...
                            <li class="payment-note">
                                <p>{{ trans('plugins/payment::payment.configuration_requirement', ['name' => 'Stripe']) }}:
                                </p>
                                <ul
                                    class="m-md-l"
                                ...
                                >
                                    ...
                                    <li style="list-style-type:decimal">
                                        <p>{{ trans('plugins/payment::payment.stripe_after_service_registration_msg', ['name' => 'Stripe']) }}
                                        </p>
                                    </li>
                                    <li style="list-style-type:decimal">
                                        <p>{{ trans('plugins/payment::payment.stripe_enter_client_id_and_secret') }}
                                        </p>
                                    </li>
                                </ul>
                    ...
                    <div class="col-sm-6">
                        <div class="bg-white well">
                            <x-core-setting::text-input
                                ...
                                :value="setting(
                                    'payment_stripe_name',
                                    trans('plugins/payment::payment.pay_online_via', ['name' => 'Stripe']),
                                )"
                            />
                            ...
                            <x-core-setting::form-group>
                                <label
                                    ...
                                    for="payment_stripe_description"
                                >{{ trans('core/base::forms.description') }}</label>
                                <textarea
                                    class="next-input"
                                    id="payment_stripe_description"
                                    name="payment_stripe_description"
                                >{{ get_payment_setting('description', 'stripe', __('Payment with :paymentType', ['paymentType' => 'Stripe'])) }}</textarea>
                            </x-core-setting::form-group>
                            ...
                            <x-core-setting::text-input
                                ...
                                :value="BaseHelper::hasDemoModeEnabled()
                                    ? '*******************************'
                                    : setting('payment_stripe_client_id')"
                                placeholder="pk_*************"
                            />
